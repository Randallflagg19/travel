...
Сверено с кодом 2026-09-07. Это отложенный инженерный backlog: архитектурные
задачи, контракты данных и тесты. Он не блокирует ближайшую продуктовую задачу
о названиях постов из [ROADMAP.md](ROADMAP.md).
